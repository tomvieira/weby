$(document).ready(function(){
  ...
  $( "<div class='news-bar-top'></div>" ).insertBefore( ".subsite_front_news_component" );
  $( "<div class='news-bar-bottom'></div>" ).insertAfter( ".subsite_front_news_component" );

  $( "<div class='event-lists-bar-top'></div>" ).insertBefore( ".event-lists" );
  $( "<div class='event-lists-bar-bottom'></div>" ).insertAfter( ".event-lists" );

  $( "<div class='social-cards-bar-top'></div>" ).insertBefore( ".social-cards" );
  $( "<div class='social-cards-bar-bottom'></div>" ).insertAfter( ".social-cards" );
